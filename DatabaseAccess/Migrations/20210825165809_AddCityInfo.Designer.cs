...
namespace DatabaseAccess.Migrations
{
    ...
    [Migration("20210825165809_AddCityInfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseAccess.BookStore.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DatabaseAccess.BookStore.Letter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DatabaseAccess.BookStore.Page", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DatabaseAccess.Entities.CityInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseAccess.Entities.WeatherInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DatabaseAccess.BookStore.Letter", b =>
                {
                    b.HasOne("DatabaseAccess.BookStore.Page", "Page")
                        .WithMany("Lettes")
            ...
            modelBuilder.Entity("DatabaseAccess.BookStore.Page", b =>
                {
                    b.HasOne("DatabaseAccess.BookStore.Book", "Book")
                        .WithMany("Pages")
